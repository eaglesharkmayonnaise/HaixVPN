//
//  CouponsViewControllerTableViewCell.m
//  Potatso
//
...
@implementation CouponsViewControllerTableViewCell
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    self.labelNewUserCoupon = [[UILabel alloc]initWithFrame:CGRectMake(120*SJwidth -18,18, kscreenw, 20)];
    self.labelNewUserCoupon.font = [UIFont fontWithName:@"SourceSansPro-bold" size:14];
    ...
    self.labelExpires = [[UILabel alloc]initWithFrame:CGRectMake(120*SJwidth -18,self.labelNewUserCoupon.frame.size.height + self.labelNewUserCoupon.frame.origin.y , kscreenw , 30)];
