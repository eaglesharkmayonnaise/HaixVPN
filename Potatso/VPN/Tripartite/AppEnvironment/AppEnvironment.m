...
+(NSUserDefaults *)SetuserDefaultsGroup{
    return [[NSUserDefaults alloc] initWithSuiteName:@"group.com.haixvpn.net"];
}
...
+(NSString *)GetNowTime{
    if ([[[NSUserDefaults standardUserDefaults] valueForKey:@"UB判断连接"] isEqualToString:@"1"]) {
        NSString* timestr = [NSString stringWithFormat:@"%@",[[[NSUserDefaults alloc] initWithSuiteName:@"group.com.haixvpn.net"] valueForKey:@"startTime"]];
